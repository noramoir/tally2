...
function SetupScreen({state,dispatch}){
  ...
  const[scoringType,setScoringType]=useState("standard");const[maxScoreInput,setMaxScoreInput]=useState("10");const[lowWins,setLowWins]=useState(false);const[custDescription,setCustDescription]=useState("");
